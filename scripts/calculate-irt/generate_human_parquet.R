...
for (year in 2019:2022) {
    ...
    students_performance <- students_performance[, c("TX_RESPOSTAS_MT", "TX_GABARITO_MT", "NU_NOTA_MT", "TX_RESPOSTAS_LC", "TX_GABARITO_LC", "NU_NOTA_LC", "TP_LINGUA", "TX_RESPOSTAS_CH", "TX_GABARITO_CH", "NU_NOTA_CH", "TX_RESPOSTAS_CN", "TX_GABARITO_CN", "NU_NOTA_CN")]
