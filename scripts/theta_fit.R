...
#response_pattern_filepath = args[1]  # "../test_responses_llms/test_responses_llms_CH.csv"

#response_pattern_filepath = "../test_responses_humans/test_responses_humans_CH.csv"

#response_pattern_filepath = "../test_responses_llms/llama2/responses/SAMPLING_CH.csv"

file_itens_prova = "../microdados_enem_2022/DADOS/ITENS_PROVA_2022.csv"
...
file_path <- paste("../IRT_fits/thetas_llms_", PROVA, ".csv", sep="")
file_conn <- file(file_path, "w")
